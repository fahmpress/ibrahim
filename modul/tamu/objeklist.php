...
$offset = ($noPage - 1) * $dataPerPage;
                    $tampil=mysql_query("select tbpengajuan.idpengajuan, tbpengajuan.deskripsi, tbpengajuan.foto, tbpengajuan.nama_wisata, tbpengajuan.nama_wisata, tbpengajuan.alamat_wisata, tbuser.nama_user from tbpengajuan, tbuser where tbuser.iduser=tbpengajuan.iduser and tbpengajuan.status='Aktif' order by idpengajuan ASC LIMIT $offset, $dataPerPage");
                    $no=1;
