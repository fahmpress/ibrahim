	...
	<div class="container">
		<div class="row">
			...
			<div class="panel panel-body">
									<form role="form" method="post" action="modul/auditor/proses.php?module=adt&act=edit-akun&iduser=<?php echo $dt[iduser] ?>" enctype='multipart/form-data' class='f-r' id="block-validate">
                                    ...
                                    <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">Hapus</a>
										...
										<input name="id" value="<?php echo $dt[iduser] ?>" class="form-control" type="text" placeholder="" readonly>
                                    </div>
									<div class="form-group">
		        				 		<label for="register-username"><b>Usernmae</b></label>
										<input name="username" value="<?php echo $dt[username] ?>" class="form-control" type="text" id="digits" readonly>
                                    </div>
                                    <div class="form-group">
		        				 		<label for="register-username"><b>Password</b></label>
										<input name="password" value="<?php echo $dt[password] ?>" class="form-control" type="text" id="digits">
                                    </div>
                                    <div class="form-group">
