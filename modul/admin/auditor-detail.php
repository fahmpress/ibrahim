                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form role="form" role="form" method="post" action="modul/admin/proses.php?module=adm&act=pengajuan-proses&id=<?php echo $data[idpengajuan]?>">
                                        <div class="form-group">
                                            <label>ID Pengajuan</label>
                                            <input value="<?php echo $data[idpengajuan]?>" class="form-control" placeholder="" readonly>
                                        </div>
                                        <div class="form-group">
