                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form role="form" role="form" method="post" action="modul/admin/proses.php?module=adm&act=pengajuan-edit">
                                        ...
                                        <div class="form-group">
                                            <label>Status</label>
                                            <input name="status" value="<?php echo $data[status]?>" class="form-control" placeholder="">
                                            </div>
